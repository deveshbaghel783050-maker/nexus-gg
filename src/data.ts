    ...
    customizations: [
      {
        ...
        options: [
          ...
          { name: 'Mokai Red Fiery (Sichuan Style)', price: 0 },
        ]
      }
    ]
  },
...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  {
    id: 'mood',
    text: 'How is the environment of modi treating you today?',
    options: [
...
export const MOKAI_GALLERY_SPACES = [
  {
    id: 'space-mures',
    title: 'Experience Mokai Interior',
    ...
    spots: [
      { x: 25, y: 35, title: 'Experience Mokai Wall', txt: 'Curated signage detailing Mokai’s journey from a humble local dream to a modi coffee sanctuary.' },
      { x: 50, y: 55, title: 'The Photo Frames', txt: 'Local creators showcase! Frames of the workers, the soil creators, and the local modi community neighbors.' },
